 ...
 * @returns {function}
 */
export declare function dateOrParse(parse: (candidate: Date | string) => Date): (dt: Date | string) => Date;
/**
 ...
 * @returns {Date}
 */
export declare function constrainDate(dt: Date, min: Date, max: Date): Date;
