(function (global, factory) {
  ...
  (global = global || self, factory(global.DateRangePicker = {}));
  ...
  */
  ...
  const TinyDatePicker$1 = TinyDatePicker;
  ...
  */
  ...
  function DateRangePicker(container, opts) {
    ...
    const start = TinyDatePicker(root.querySelector('.dr-cal-start'), cp({}, opts.startOpts, {
      mode: 'dp-permanent',
      dateClass: dateClass,
    }));
    const end = TinyDatePicker(root.querySelector('.dr-cal-end'), cp({}, opts.endOpts, {
      mode: 'dp-permanent',
