...
import { IDatePickerOptions, IAlignment } from '../interfaces';

export default function DropdownMode(input: HTMLInputElement, emit: any, opts: IDatePickerOptions) {
...
function autoPosition(input: HTMLInputElement, dp: any, alignment: IAlignment) {
...
function adjustCalX(dp: any, inputPos: DOMRect, win: Window, alignment: IAlignment) {
    const cal = dp.el;
...
function adjustCalY(dp: any, inputPos: DOMRect, win: Window) {
    const cal = dp.el;
